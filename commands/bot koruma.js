...
.setDescription(`<a:kilit:1178729393246437457> ***Bot Koruma Sistem Bilgilendirmesi***\n *Sunucuya eklenen botları sunucudan atar.*\n`)
.addField(`<a:kilit:1178729393246437457> **Nasıl Açacağım?**`,"`.bot-koruma aç`\n")
.addField(`<a:kilit:1178729393246437457> **Nasıl Kapatacağım?**`,"`.bot-koruma kapat`\n")
.addField(`<a:kilit:1178729393246437457> **Nasıl İzin Vereceğim?**`,"`.bot-izin ID`\n")
.addField(`<a:kilit:1178729393246437457> **Nasıl İzin Kaldıracağım?**`,"`.bot-izin-kaldır ID`\n")
