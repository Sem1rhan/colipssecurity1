...
client.on('ready', async () => {
   var oyun = [
    ...
    setInterval(function() {
        ...
        client.user.setActivity(oyun[random],"Colips Security");
        }, 2 * 2500);
...
var dokunulmaz =  db.fetch(`dokunulmaz.${message.guild.id}`)
  ...
  const embed = new Discord.MessageEmbed()
    ...
    .addField("<a:kilit:1178729393246437457> Kullanıcı", message.author)
    .addField("<a:kilit:1178729393246437457> Kanal", message.channel)
    .addField("<:yildiz:1178733357752926248> Silinen Mesaj", + message.content)
...
var chid = db.fetch(`msglog.${newMessage.guild.id}`)
  ...
  let embed = new Discord.MessageEmbed()
    ...
    .setTimestamp()
    .addField("<a:kilit:1178729393246437457> Kullanıcı", newMessage.author)
    .addField("<a:kilit:1178729393246437457> Kanal", newMessage.channel)
    .addField("<:yildiz:1178733357752926248> Eski Mesaj", oldMessage.content)
    .addField("<:yildiz:1178733357752926248> Yeni Mesaj", newMessage.content)
    .addField("<:yildiz:1178733357752926248> Mesaj ID'si", newMessage.id)
...
.addField("<:yildiz:1178733357752926248> Yetkili", member)
.addField("<:yildiz:1178733357752926248> Silinen Rol", rol)
...
.addField("<:yildiz:1178733357752926248> Yetkili", member)
.addField("<:yildiz:1178733357752926248> Oluşturulan Rol Adı", rol.name)
.setThumbnail(member.user.avatarURL({dynamic: true,format: "gif",format: "png",format: "jpg",size: 2048}))
.setFooter(client.user.username,client.user.avatarURL())
  client.channels.cache.get(db.fetch(`rollog.${role.guild.id}`)).send(emb1)
   }})
...
.setTitle(`Sunucuda Bir Rol Oluşturuldu.`)
.addField("<:yildiz:1178733357752926248> Yetkili", member)
.addField("<:yildiz:1178733357752926248> Düzenlenen Rol", newRole)
.setThumbnail(member.user.avatarURL({dynamic: true,format: "gif",format: "png",format: "jpg",size: 2048}))
.setFooter(client.user.username,client.user.avatarURL())
  client.channels.cache.get(db.fetch(`rollog.${newRole.guild.id}`)).send(emb1)
   ...
   client.on('channelDelete', async function(channel) {
    ...
    if(channel.type === "voice") {
      ...
      .addField("<:yildiz:1178733357752926248> Yetkili", yapanad)
      .addField("<:yildiz:1178733357752926248> Silinen Kanal", channel.name)
      .addField("<:yildiz:1178733357752926248> Kanal Kategorisi", channel.parent)
      .addField("<:yildiz:1178733357752926248> Kanal Türü", "Ses Kanalı")
      .setFooter(client.user.username,client.user.avatarURL())
    ...
    if(channel.type === "text") {
      ...
      channel.clone(this.name,true,true).then(kanal => {
        ...
        .setTitle(`Sunucuda Bir Kanal Silindi`)
        .addField("<:yildiz:1178733357752926248> Yetkili", yapanad)
        .addField("<:yildiz:1178733357752926248> Silinen Kanal", kanal)
        .addField("<:yildiz:1178733357752926248> Kanal Kategorisi", channel.parent)
        .addField("<:yildiz:1178733357752926248> Kanal Türü", "Metin Kanalı")
        .setFooter(client.user.username,client.user.avatarURL())
        client.channels.cache.get(db.fetch(`kanallog.${channel.guild.id}`)).send(emb1)
        let z = channel.guild.channels.cache.get(kanal.id)
        z.setParent(z.guild.channels.cache.find(channel => channel.id === kategoriID))
...
client.on("ready", async () => {
  ...
  client.on("channelUpdate", async (oldChannel, newChannel) => {
    ...
    if(oldChannel.type === "voice") {
      ...
      .addField("<:yildiz:1178733357752926248> Yetkili", yapanad)
      .addField("<:yildiz:1178733357752926248> Düzenlenen Kanal", oldChannel.name)
      .addField("<:yildiz:1178733357752926248> Kanal Kategorisi", oldChannel.parent)
      .addField("<:yildiz:1178733357752926248> Kanal Türü", "Ses Kanalı")
      .setFooter(client.user.username,client.user.avatarURL())
    ...
    if(oldChannel.type === "text") {
      ...
      let nsfw = oldChannel.nsfw;
        ...
        .setTitle(`Sunucuda Bir Kanal Düzenlendi`)
        .addField("<:yildiz:1178733357752926248> Yetkili", yapanad)
        .addField("<:yildiz:1178733357752926248> Düzenlenen Kanal", oldChannel)
        .addField("<:yildiz:1178733357752926248> Kanal Kategorisi", oldChannel.parent)
        .addField("<:yildiz:1178733357752926248> Kanal Türü", "Metin Kanalı")
        .setFooter(client.user.username,client.user.avatarURL())
        client.channels.cache.get(db.fetch(`kanallog.${newChannel.guild.id}`)).send(emb1)
  ...
  client.on('channelCreate', async function(channel) {
    ...
    if(channel.type === "voice") {
      ...
      .addField("<:yildiz:1178733357752926248> Yetkili", yapanad)
      .addField("<:yildiz:1178733357752926248> Açılan Kanal", channel.name)
      .addField("<:yildiz:1178733357752926248> Kanal Kategorisi", channel.parent)
      .addField("<:yildiz:1178733357752926248> Kanal Türü", "Ses Kanalı")
      .setFooter(client.user.username,client.user.avatarURL())
      client.channels.cache.get(db.fetch(`kanallog.${channel.guild.id}`)).send(emb1)
...
client.on('emojiDelete', async function(emoji) {
  ...
  member.roles.set("")
    ...
    .addField("<:yildiz:1178733357752926248> Yetkili", yapanad)
    .addField("<:yildiz:1178733357752926248> Silinen Emoji", `${emoji.name}`)
    .setFooter(client.user.username,client.user.avatarURL())
  ...
  client.on("emojiUpdate", async (oldEmoji, newEmoji) => {
    ...
    if(guild.owner.id !== member.id && !member.roles.cache.has(dokunulmaz)){
      ...
      .addField("<:yildiz:1178733357752926248> Yetkili", yapanad)
      .addField("<:yildiz:1178733357752926248> Emoji Adı", oldEmoji.name)
      .addField("<:yildiz:1178733357752926248> Düzenlenmiş Emoji Adı", newEmoji.name)
      .setFooter(client.user.username,client.user.avatarURL())
  ...
  client.on('emojiCreate', async function(emoji) {
    ...
    if(guild.owner.id !== member.id && !member.roles.cache.has(dokunulmaz)){
      ...
      .addField("<:yildiz:1178733357752926248> Yetkili", yapanad)
      .addField("<:yildiz:1178733357752926248> Emoji Adı", emoji.name)
      .setThumbnail(`https://cdn.discordapp.com/emojis/${emoji.id}.${uzantı}?v=1`)
      .setFooter(client.user.username,client.user.avatarURL())
...
client.on("guildMemberAdd", async member => {
  ...
  .addField("<:yildiz:1178733357752926248> Katılan Bot :", member.user.tag)
  .addField("<:yildiz:1178733357752926248> Katılan Bot ID :", member.id)
  .addField("<:yildiz:1178733357752926248> Bot İzin Komutu :", `.bot-izin ${member.id}`)
...
client.on("guildCreate", (guild,bot) => {
  ...
  const embed = new Discord.MessageEmbed()
    ...
    .setColor("BLUE")
    .addField("<:yildiz:1178733357752926248> Sunucu İsmi:", guild.name)
    .addField("<:yildiz:1178733357752926248> Sunucu ID:", guild.id)
    .addField("<:yildiz:1178733357752926248> Sunucu Sahibi:", guild.owner)
    .addField("<:yildiz:1178733357752926248> Sunucu Bölgesi:", guild.region)
    .addField("<:yildiz:1178733357752926248> Sunucu Üye Sayısı:", guild.members.cache.size)
    .addField("<:yildiz:1178733357752926248> Sunucu Kanal Sayısı:", guild.channels.cache.size)
    .addField("<:yildiz:1178733357752926248> Sunucu Rol Sayısı:", guild.roles.cache.size)
    .setTimestamp()
    .setFooter(client.user.username, client.user.avatarURL);
  log.send(embed);
});
